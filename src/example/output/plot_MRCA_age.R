...
legend("topright", legend=c("Coalescence time probability distribution (N=200)", "Coalescence time probability distribution (N=+Inf)"), col=c("orange", "blue"), lwd=c(3,1), lty=c(2,1))
